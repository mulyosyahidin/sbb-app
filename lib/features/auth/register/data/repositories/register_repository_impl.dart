...
import 'package:app/features/auth/register/data/mappers/register_mapper.dart';
...
class RegisterRepositoryImpl implements RegisterRepository {
  ...
  @override
  Future<Result<RegisterUser>> register(RegisterRequestDto registerRequestDto) async {
    try {
      final response = await _registerRemoteDatasource.register(registerRequestDto);

      return Result.success(RegisterMapper.toEntity(response.data!));
    } catch (e) {
