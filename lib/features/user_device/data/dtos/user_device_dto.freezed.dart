...
mixin _$UserDeviceDto {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, fcmToken, deviceId,
      deviceBrand, deviceModel, osVersion, osBuildId);

  @override
  String toString() {
    return 'UserDeviceDto(id: $id, fcmToken: $fcmToken, deviceId: $deviceId, deviceBrand: $deviceBrand, deviceModel: $deviceModel, osVersion: $osVersion, osBuildId: $osBuildId)';
  }
}
