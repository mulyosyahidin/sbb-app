...
class _OpenPartnerPageState extends ConsumerState<OpenPartnerPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Buka Kemitraan'),
      ),
          ...
          child: Column(
            ...
            children: [
              ...
              bankAccountsState.when(
                ...
                error: (error, _) => Text('Gagal memuat rekening: $error'),
              ),
              const SizedBox(height: 20),
                        ...
                        children: [
                          ...
                          Text(
                            _tanggalBergabung == null
                                ? 'Pilih tanggal'
                                : DateFormat('dd MMMM yyyy').format(_tanggalBergabung!),
              ...
              Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  ..._kontrakOptions.map((option) => RadioListTile<String>(
                        title: Text(option),
                        value: option,
              ...
              PrimaryButton(
                onPressed: () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Form disubmit (Dummy)')),
                  );
                },
                label: 'SUBMIT',
              ), 
